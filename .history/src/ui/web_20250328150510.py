...
def open_file_dialog(select_type: str = 'file') -> Optional[str]:
    """
    Öffnet einen Datei- oder Ordnerauswahldialog mit Streamlit.
    ...
    """
    if select_type == 'file':
        uploaded_file = st.file_uploader("Wählen Sie eine DOCX-Datei", type=['docx'])
        ...
        st.warning("Ordnerauswahl wird in dieser Version noch nicht unterstützt.")
